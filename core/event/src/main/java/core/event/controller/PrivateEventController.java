...
public class PrivateEventController {
    ...
    @GetMapping("/{eventId}")
    public EventFullDto find(@PathVariable @Positive Long userId,
    ...
    public UpdRequestsStatusResult updateRequests(@PathVariable @Positive Long userId,
                                                  @PathVariable @Positive Long eventId,
    ...
    public boolean existsByIdAndInitiator(@PathVariable @Positive Long userId,
                                          @PathVariable @Positive Long eventId) {
