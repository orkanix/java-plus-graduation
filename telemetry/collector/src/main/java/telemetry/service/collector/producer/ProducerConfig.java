...
public class ProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, UserActionAvro> producerFactory() throws ClassNotFoundException {
    ...
    @Bean
    public KafkaTemplate<String, UserActionAvro> kafkaTemplate() throws ClassNotFoundException {
